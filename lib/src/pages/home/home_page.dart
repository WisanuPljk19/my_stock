...
import 'package:my_stock/src/model/product_response.dart';
import 'package:my_stock/src/pages/login/background_theme.dart';
import 'package:my_stock/src/service/network.dart';
            ...
            child: GridView.builder(
              ...
              itemBuilder: (context, index) => LayoutBuilder(
                builder: (context, constraint) => ShopListItem(
                    constraint.maxHeight, productList[index], press: () async {
        ...
        children: [
          ...
          ListTile(
            onTap: () async {
              ...
              await prefs.remove(AppSettings.tokenSetting);
